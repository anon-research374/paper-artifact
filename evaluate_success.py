...
def compare_message_accuracy(json_obj, bit_length, mat_height, seg_length, device):
    try:
        ...
        if are_equal:
            print(f"✅ Object idx {idx}: The complete part of the message matches (Partial Match).")
            print(f"   Verified {matching_bits}/{msg_length} bits")
        else:
            print(f"❌ Object idx {idx}: The complete part of the message is inconsistent.")
...
def main():
    ...
    try:
        ...
        if processed_count > 0:
            ...
            print(f"🎯(Partial Match Accuracy): {accuracy:.2f}%")
